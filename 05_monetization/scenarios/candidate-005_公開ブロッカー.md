...
> - AdSense / AdMob = Google の広告 SDK（Web / アプリ向け）
> - Vercel / Netlify / GitHub Pages / Cloudflare Pages = 静的サイトを公開する無料サービス
> - Ollama / OpenAI Playground / llama.cpp = ローカル / クラウドで LLM を動かす代表的なツール
> - 規約整理 = 取り込んでよいデータの範囲・出典明示ルールを明文化すること
