...
- 最大 **10 件**まで処理する
- 最大 **4 時間**まで連続実行する（開始時刻を記録し、各サイクル開始前に経過時間を確認）
