...
- 2026-07-19 runId: 20260719-112010 — 判断カード機械文ガード(lint)+危険判断のプロジェクト単位ブロック化+iOSビルド使い方ガイド（関連: [[../20_reviews/2026-07-19_card-lint-danger-scope-usage]]）
- 次の確認事項: 次回定時自動実行後にautomation logで「危険判断待ちにより〜を除外して続行」を確認
